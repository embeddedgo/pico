...
func OUTTOPAD_(p *Periph, i int) mmio.RM32[STATUS] {
	return mmio.RM32[STATUS]{&p.GPIO[i].STATUS, OUTTOPAD}
}
func OETOPAD_(p *Periph, i int) mmio.RM32[STATUS] {
	return mmio.RM32[STATUS]{&p.GPIO[i].STATUS, OETOPAD}
}
func INFROMPAD_(p *Periph, i int) mmio.RM32[STATUS] {
	return mmio.RM32[STATUS]{&p.GPIO[i].STATUS, INFROMPAD}
}
func IRQTOPROC_(p *Periph, i int) mmio.RM32[STATUS] {
	return mmio.RM32[STATUS]{&p.GPIO[i].STATUS, IRQTOPROC}
}

type CTRL uint32

func FUNCSEL_(p *Periph, i int) mmio.RM32[CTRL] { return mmio.RM32[CTRL]{&p.GPIO[i].CTRL, FUNCSEL} }
func OUTOVER_(p *Periph, i int) mmio.RM32[CTRL] { return mmio.RM32[CTRL]{&p.GPIO[i].CTRL, OUTOVER} }
func OEOVER_(p *Periph, i int) mmio.RM32[CTRL]  { return mmio.RM32[CTRL]{&p.GPIO[i].CTRL, OEOVER} }
func INOVER_(p *Periph, i int) mmio.RM32[CTRL]  { return mmio.RM32[CTRL]{&p.GPIO[i].CTRL, INOVER} }
func IRQOVER_(p *Periph, i int) mmio.RM32[CTRL] { return mmio.RM32[CTRL]{&p.GPIO[i].CTRL, IRQOVER} }
