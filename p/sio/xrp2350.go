...
func VLD_(p *Periph) mmio.RM32[FIFO_ST] { return mmio.RM32[FIFO_ST]{&p.FIFO_ST, VLD} }
func RDY_(p *Periph) mmio.RM32[FIFO_ST] { return mmio.RM32[FIFO_ST]{&p.FIFO_ST, RDY} }
func WOF_(p *Periph) mmio.RM32[FIFO_ST] { return mmio.RM32[FIFO_ST]{&p.FIFO_ST, WOF} }
func ROE_(p *Periph) mmio.RM32[FIFO_ST] { return mmio.RM32[FIFO_ST]{&p.FIFO_ST, ROE} }
...
func INTERP0_(p *Periph) mmio.RM32[PERI_NONSEC] {
	return mmio.RM32[PERI_NONSEC]{&p.PERI_NONSEC, INTERP0}
}
func INTERP1_(p *Periph) mmio.RM32[PERI_NONSEC] {
	return mmio.RM32[PERI_NONSEC]{&p.PERI_NONSEC, INTERP1}
}
func TMDS_(p *Periph) mmio.RM32[PERI_NONSEC] { return mmio.RM32[PERI_NONSEC]{&p.PERI_NONSEC, TMDS} }

type RISCV_SOFTIRQ uint32

func CORE0_SET_(p *Periph) mmio.RM32[RISCV_SOFTIRQ] {
	return mmio.RM32[RISCV_SOFTIRQ]{&p.RISCV_SOFTIRQ, CORE0_SET}
}
func CORE1_SET_(p *Periph) mmio.RM32[RISCV_SOFTIRQ] {
	return mmio.RM32[RISCV_SOFTIRQ]{&p.RISCV_SOFTIRQ, CORE1_SET}
}
func CORE0_CLR_(p *Periph) mmio.RM32[RISCV_SOFTIRQ] {
	return mmio.RM32[RISCV_SOFTIRQ]{&p.RISCV_SOFTIRQ, CORE0_CLR}
}
func CORE1_CLR_(p *Periph) mmio.RM32[RISCV_SOFTIRQ] {
	return mmio.RM32[RISCV_SOFTIRQ]{&p.RISCV_SOFTIRQ, CORE1_CLR}
}

type MTIME_CTRL uint32

func EN_(p *Periph) mmio.RM32[MTIME_CTRL] { return mmio.RM32[MTIME_CTRL]{&p.MTIME_CTRL, EN} }
func FULLSPEED_(p *Periph) mmio.RM32[MTIME_CTRL] {
	return mmio.RM32[MTIME_CTRL]{&p.MTIME_CTRL, FULLSPEED}
}
func DBGPAUSE_CORE0_(p *Periph) mmio.RM32[MTIME_CTRL] {
	return mmio.RM32[MTIME_CTRL]{&p.MTIME_CTRL, DBGPAUSE_CORE0}
}
func DBGPAUSE_CORE1_(p *Periph) mmio.RM32[MTIME_CTRL] {
	return mmio.RM32[MTIME_CTRL]{&p.MTIME_CTRL, DBGPAUSE_CORE1}
}

type TMDS_CTRL uint32

func L0_ROT_(p *Periph) mmio.RM32[TMDS_CTRL]   { return mmio.RM32[TMDS_CTRL]{&p.TMDS_CTRL, L0_ROT} }
func L1_ROT_(p *Periph) mmio.RM32[TMDS_CTRL]   { return mmio.RM32[TMDS_CTRL]{&p.TMDS_CTRL, L1_ROT} }
func L2_ROT_(p *Periph) mmio.RM32[TMDS_CTRL]   { return mmio.RM32[TMDS_CTRL]{&p.TMDS_CTRL, L2_ROT} }
func L0_NBITS_(p *Periph) mmio.RM32[TMDS_CTRL] { return mmio.RM32[TMDS_CTRL]{&p.TMDS_CTRL, L0_NBITS} }
func L1_NBITS_(p *Periph) mmio.RM32[TMDS_CTRL] { return mmio.RM32[TMDS_CTRL]{&p.TMDS_CTRL, L1_NBITS} }
func L2_NBITS_(p *Periph) mmio.RM32[TMDS_CTRL] { return mmio.RM32[TMDS_CTRL]{&p.TMDS_CTRL, L2_NBITS} }
func INTERLEAVE_(p *Periph) mmio.RM32[TMDS_CTRL] {
	return mmio.RM32[TMDS_CTRL]{&p.TMDS_CTRL, INTERLEAVE}
}
func PIX_SHIFT_(p *Periph) mmio.RM32[TMDS_CTRL] { return mmio.RM32[TMDS_CTRL]{&p.TMDS_CTRL, PIX_SHIFT} }
func PIX2_NOSHIFT_(p *Periph) mmio.RM32[TMDS_CTRL] {
	return mmio.RM32[TMDS_CTRL]{&p.TMDS_CTRL, PIX2_NOSHIFT}
}
func CLEAR_BALANCE_(p *Periph) mmio.RM32[TMDS_CTRL] {
	return mmio.RM32[TMDS_CTRL]{&p.TMDS_CTRL, CLEAR_BALANCE}
}
