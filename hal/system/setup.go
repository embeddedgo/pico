...
// SetupPico2 setups the whole system to run at 150 MHz assuming it is an
// RPI Pico 2 compatible: 12 MHz XOSC, 133 MHz QSPI Flash (66 MHz Read Data).
func SetupPico2() {
	Setup(12e6, PLL{1, 125, 5, 2}, PLL{1, 100, 5, 5})
}
...
func Setup(xoscHz int64, sys, usb PLL) {
